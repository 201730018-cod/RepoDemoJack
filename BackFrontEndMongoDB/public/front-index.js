...
form.addEventListener("submit", async (e)=>{
    ...
    console.log("ID al hacer submit:", id); // ← agrega esto
    ...
    console.log("Usuario a enviar:", usuario); // ← y esto


    if(id){
        console.log("Ejecutando PUT..."); // ← y esto
        ...
        console.log("Ejecutando POST..."); // ← y esto
